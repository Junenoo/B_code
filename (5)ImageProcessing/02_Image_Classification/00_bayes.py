...
pred_text = ['the close but forgettable election', 'the very very forgettable match']
...
bnb = MultinomialNB()
bnb.fit(text_encode, label_encode)
pred_label_encode = bnb.predict(pred_text_encode)
...
# 查看概率
prob = bnb.predict_proba(pred_text_encode)
